...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'jane.smith@example.com' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Prefers quiet sessions, allergic to certain scented oils' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
