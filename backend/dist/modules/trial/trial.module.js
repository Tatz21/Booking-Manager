...
exports.TrialModule = TrialModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [trial_service_1.TrialService, subscription_guard_1.SubscriptionGuard],
        exports: [trial_service_1.TrialService, subscription_guard_1.SubscriptionGuard],
    })
], TrialModule);
